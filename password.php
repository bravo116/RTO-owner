                ...
                <div class="suri">
					<form method="post" action="python.php">
						<div id="formdiv" style="font-weight:bolder;font-size:20px;padding: 15px;margin-bottom: 30px;">
							<h1 style="text-align:center;font-weight: bolder; color:white">FORGOT PASSWORD! </h1>
							<br>
                            ...
                            <br>
							<div class="col-lg-6">
								<input type="submit" class="col-lg-12 btn btn-primary form-control" id="btn_login" name="btn_login" value="Send OTP"/>
							</div>
							
							<div class="col-lg-6">
								<input type="reset" class="col-lg-6 btn btn-danger form-control" required/>
							</div>
                            <div>
                        ...
                        <div style="color:white">
                            ...
                            <br>
                        <input type="submit" class="form-control" id="verify" name="verify" value="Verify!" >
                        </form>\
                </div>
				</div>
