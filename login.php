...
<head>
    ...
    <style>
            ...
            .suri{ border: 2px solid white; margin-top: 50px;}
            ...
            <div class="col-lg-6">
					...
					<form method="post" action="loginc.php">
						<div id="formdiv" style="font-weight:bolder;font-size:20px;padding: 15px;margin-bottom: 30px;">
							<h1 style="text-align:center;font-weight: bolder; color: white">Login Form </h1>
							<br>
                            ...
                            <br><br>
							<div class="col-lg-6">
								<input type="submit" class="col-lg-12 btn btn-primary form-control" id="btn_login" name="btn_login" value="Login"/>
							</div>
